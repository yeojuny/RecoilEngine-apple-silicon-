 ...
 */
EXPORT(bool) bridged_DataDirs_locatePath(int skirmishAIId, char* path, int path_sizeMax, const char* const relPath, bool writeable, bool create, bool dir, bool common); // RET_STRING:path:path_sizeMax
 ...
 */
EXPORT(bool) bridged_DataDirs_Roots_getDir(int skirmishAIId, char* path, int path_sizeMax, int dirIndex); // RET_STRING:path:path_sizeMax
 ...
 *          -> the path exists and is stored in an absolute form in path
 */
EXPORT(bool) bridged_DataDirs_Roots_locatePath(int skirmishAIId, char* path, int path_sizeMax, const char* const relPath, bool writeable, bool create, bool dir); // RET_STRING:path:path_sizeMax
 ...
 */
EXPORT(int) bridged_getEnemyUnitsIn(int skirmishAIId, float* pos_posF3, float radius, bool spherical, int* unitIds, int unitIds_sizeMax); // FETCHER:MULTI:IDs:Unit:unitIds
 ...
 */
EXPORT(int) bridged_getFriendlyUnitsIn(int skirmishAIId, float* pos_posF3, float radius, bool spherical, int* unitIds, int unitIds_sizeMax); // FETCHER:MULTI:IDs:Unit:unitIds
 ...
 */
EXPORT(int) bridged_getNeutralUnitsIn(int skirmishAIId, float* pos_posF3, float radius, bool spherical, int* unitIds, int unitIds_sizeMax); // FETCHER:MULTI:IDs:Unit:unitIds
...
EXPORT(int) bridged_Unit_getWeapons(int skirmishAIId, int unitId); // FETCHER:MULTI:NUM:Weapon

EXPORT(int) bridged_Unit_getWeapon(int skirmishAIId, int unitId, int weaponMountId); // REF:weaponMountId->WeaponMount REF:RETURN->Weapon
...
EXPORT(int) bridged_getAlliedTeams(int skirmishAIId, int* teamIds, int teamIds_sizeMax); // FETCHER:MULTI:IDs:Team:teamIds
 ...
 * @see getLosMap()
 */
EXPORT(int) bridged_Map_getAirLosMap(int skirmishAIId, int* airLosValues, int airLosValues_sizeMax); // ARRAY:airLosValues
 ...
 * @see getRadarMap()
 */
EXPORT(int) bridged_Map_getSonarMap(int skirmishAIId, int* sonarValues, int sonarValues_sizeMax); // ARRAY:sonarValues

/**
 * @see getRadarMap()
 */
EXPORT(int) bridged_Map_getSeismicMap(int skirmishAIId, int* seismicValues, int seismicValues_sizeMax); // ARRAY:seismicValues
 ...
 * @see getRadarMap()
 */
EXPORT(int) bridged_Map_getSonarJammerMap(int skirmishAIId, int* sonarJammerValues, int sonarJammerValues_sizeMax); // ARRAY:sonarJammerValues
 ...
 * @see getHardness()
 */
EXPORT(int) bridged_Map_getHardnessModMap(int skirmishAIId, float* hardMods, int hardMods_sizeMax); // ARRAY:hardMods
 ...
 */
EXPORT(int) bridged_Map_getSpeedModMap(int skirmishAIId, int speedModClass, float* speedMods, int speedMods_sizeMax); // ARRAY:speedMods
 ...
 */
EXPORT(int) bridged_getFeaturesIn(int skirmishAIId, float* pos_posF3, float radius, bool spherical, int* featureIds, int featureIds_sizeMax); // REF:MULTI:featureIds->Feature
...
EXPORT(int) bridged_Feature_getResurrectDef(int skirmishAIId, int featureId); // REF:RETURN->UnitDef
...
EXPORT(int) bridged_Unit_Weapon_getDef(int skirmishAIId, int unitId, int weaponId); // REF:RETURN->WeaponDef
 ...
 * @param ret_outData  Buffer for response, must be const size of MAX_RESPONSE_SIZE bytes
 */
EXPORT(int) bridged_Lua_callRules(int skirmishAIId, const char* inData, int inSize, char* ret_outData); // error-return:0=OK
 ...
 * @param ret_outData  Buffer for response, must be const size of MAX_RESPONSE_SIZE bytes
 */
EXPORT(int) bridged_Lua_callUI(int skirmishAIId, const char* inData, int inSize, char* ret_outData); // error-return:0=OK
...
EXPORT(int) bridged_Debug_addOverlayTexture(int skirmishAIId, const float* texData, int w, int h); // REF:ret_overlayTextureId->OverlayTexture
