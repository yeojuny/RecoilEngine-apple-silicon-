...
public:
	 ...
	 */
	// @Override
	virtual float GetRulesParamFloat(const char* featureRulesParamName, float defaultValue);
	/**
	 * @return string value of parameter if it's set, defaultValue otherwise.
	 */
	// @Override
	virtual const char* GetRulesParamString(const char* featureRulesParamName, const char* defaultValue);
private:
	springai::UnitDef* resurrectDef;/* = 0;*/ // TODO: FIXME: put this into a constructor
public:
	virtual void SetResurrectDef(springai::UnitDef* resurrectDef);
	// @Override
	virtual springai::UnitDef* GetResurrectDef();
private:
	short buildingFacing;/* = 0;*/ // TODO: FIXME: put this into a constructor
public:
	virtual void SetBuildingFacing(short buildingFacing);
	// @Override
	virtual short GetBuildingFacing();
}; // class StubFeature
