...
#include "IncludesSources.h"
	...
	float springai::StubFeature::GetRulesParamFloat(const char* featureRulesParamName, float defaultValue) {
		return 0;
	}

	const char* springai::StubFeature::GetRulesParamString(const char* featureRulesParamName, const char* defaultValue) {
		return 0;
	}

	void springai::StubFeature::SetResurrectDef(springai::UnitDef* resurrectDef) {
		this->resurrectDef = resurrectDef;
	}
	springai::UnitDef* springai::StubFeature::GetResurrectDef() {
		return resurrectDef;
	}

	void springai::StubFeature::SetBuildingFacing(short buildingFacing) {
		this->buildingFacing = buildingFacing;
	}
	short springai::StubFeature::GetBuildingFacing() {
