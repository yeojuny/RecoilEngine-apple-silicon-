...
#include "IncludesSources.h"
	...
	void springai::StubOOAICallback::SetNumTeams(int numTeams) {
		this->numTeams = numTeams;
	}
	int springai::StubOOAICallback::GetNumTeams() {
		return numTeams;
	}

	void springai::StubOOAICallback::SetNumSkirmishAIs(int numSkirmishAIs) {
		this->numSkirmishAIs = numSkirmishAIs;
	}
	int springai::StubOOAICallback::GetNumSkirmishAIs() {
		return numSkirmishAIs;
	}

	void springai::StubOOAICallback::SetMaxSkirmishAIs(int maxSkirmishAIs) {
		this->maxSkirmishAIs = maxSkirmishAIs;
	}
	int springai::StubOOAICallback::GetMaxSkirmishAIs() {
		return maxSkirmishAIs;
	}
	...
	std::vector<springai::Unit*> springai::StubOOAICallback::GetEnemyUnitsIn(const springai::AIFloat3& pos, float radius, bool spherical) {
	...
	std::vector<springai::Unit*> springai::StubOOAICallback::GetFriendlyUnitsIn(const springai::AIFloat3& pos, float radius, bool spherical) {
		return std::vector<springai::Unit*>();
	}
	...
	std::vector<springai::Unit*> springai::StubOOAICallback::GetNeutralUnitsIn(const springai::AIFloat3& pos, float radius, bool spherical) {
		return std::vector<springai::Unit*>();
	}
	...
	void springai::StubOOAICallback::SetAlliedTeams(std::vector<springai::Team*> alliedTeams) {
		this->alliedTeams = alliedTeams;
	}
	std::vector<springai::Team*> springai::StubOOAICallback::GetAlliedTeams() {
		return alliedTeams;
	}
	...
	std::vector<springai::Feature*> springai::StubOOAICallback::GetFeaturesIn(const springai::AIFloat3& pos, float radius, bool spherical) {
