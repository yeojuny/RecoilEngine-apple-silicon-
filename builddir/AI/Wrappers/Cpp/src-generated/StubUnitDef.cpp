...
#include "IncludesSources.h"
	...
	void springai::StubUnitDef::SetUpDirSmoothing(float upDirSmoothing) {
		this->upDirSmoothing = upDirSmoothing;
	}
	float springai::StubUnitDef::GetUpDirSmoothing() {
		return upDirSmoothing;
	}
