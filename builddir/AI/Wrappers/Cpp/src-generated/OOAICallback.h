...
public:
	 ...
	 */
public:
	virtual int GetNumSkirmishAIs() = 0;

	/**
	 * Returns the maximum number of skirmish AIs in any game
	 */
public:
	virtual int GetMaxSkirmishAIs() = 0;
...
public:
	 ...
	 */
public:
	virtual std::vector<springai::Unit*> GetEnemyUnitsIn(const springai::AIFloat3& pos, float radius, bool spherical) = 0;
...
public:
	 ...
	 */
public:
	virtual std::vector<springai::Unit*> GetFriendlyUnitsIn(const springai::AIFloat3& pos, float radius, bool spherical) = 0;
...
public:
	 ...
	 */
public:
	virtual std::vector<springai::Unit*> GetNeutralUnitsIn(const springai::AIFloat3& pos, float radius, bool spherical) = 0;
...
public:
	virtual std::vector<springai::Team*> GetAlliedTeams() = 0;
...
public:
	 ...
	 */
public:
	virtual std::vector<springai::Feature*> GetFeaturesIn(const springai::AIFloat3& pos, float radius, bool spherical) = 0;
