...
private:
	bool isAutoreclaimable;/* = false;*/ // TODO: FIXME: put this into a constructor
public:
	virtual void SetAutoreclaimable(bool isAutoreclaimable);
	// @Override
	virtual bool IsAutoreclaimable();
private:
