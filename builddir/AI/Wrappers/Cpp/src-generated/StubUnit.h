...
public:
	 ...
	 */
	// @Override
	virtual float GetRulesParamFloat(const char* unitRulesParamName, float defaultValue);
	/**
	 * @return string value of parameter if it's set, defaultValue otherwise.
	 */
	// @Override
	virtual const char* GetRulesParamString(const char* unitRulesParamName, const char* defaultValue);
private:
...
private:
	float paralyzeDamage;/* = 0;*/ // TODO: FIXME: put this into a constructor
public:
	virtual void SetParalyzeDamage(float paralyzeDamage);
	// @Override
	virtual float GetParalyzeDamage();
private:
	float captureProgress;/* = 0;*/ // TODO: FIXME: put this into a constructor
public:
	virtual void SetCaptureProgress(float captureProgress);
	// @Override
	virtual float GetCaptureProgress();
private:
	float buildProgress;/* = 0;*/ // TODO: FIXME: put this into a constructor
public:
	virtual void SetBuildProgress(float buildProgress);
	// @Override
...
private:
	std::vector<springai::Weapon*> weapons;/* = std::vector<springai::Weapon*>();*/ // TODO: FIXME: put this into a constructor
public:
	virtual void SetWeapons(std::vector<springai::Weapon*> weapons);
	// @Override
	virtual std::vector<springai::Weapon*> GetWeapons();
	// @Override
	virtual springai::Weapon* GetWeapon(WeaponMount* weaponMount);
	/**
