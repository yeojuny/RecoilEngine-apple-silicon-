...
public:
	 ...
	 */
public:
	virtual std::vector<int> GetAirLosMap() = 0;
...
public:
	 ...
	 */
public:
	virtual std::vector<int> GetSonarMap() = 0;

	/**
	 * @see getRadarMap()
	 */
public:
	virtual std::vector<int> GetSeismicMap() = 0;
...
public:
	 ...
	 */
public:
	virtual std::vector<int> GetSonarJammerMap() = 0;
...
public:
	 ...
	 */
public:
	virtual std::vector<float> GetHardnessModMap() = 0;
	 ...
	 */
public:
	virtual std::vector<float> GetSpeedModMap(int speedModClass) = 0;
