...
#include "IncludesSources.h"
	...
	float springai::StubUnit::GetRulesParamFloat(const char* unitRulesParamName, float defaultValue) {
		return 0;
	}

	const char* springai::StubUnit::GetRulesParamString(const char* unitRulesParamName, const char* defaultValue) {
		return 0;
	}
	...
	void springai::StubUnit::SetParalyzeDamage(float paralyzeDamage) {
		this->paralyzeDamage = paralyzeDamage;
	}
	float springai::StubUnit::GetParalyzeDamage() {
		return paralyzeDamage;
	}

	void springai::StubUnit::SetCaptureProgress(float captureProgress) {
		this->captureProgress = captureProgress;
	}
	float springai::StubUnit::GetCaptureProgress() {
		return captureProgress;
	}

	void springai::StubUnit::SetBuildProgress(float buildProgress) {
		this->buildProgress = buildProgress;
	}
	float springai::StubUnit::GetBuildProgress() {
	...
	void springai::StubUnit::SetWeapons(std::vector<springai::Weapon*> weapons) {
		this->weapons = weapons;
	}
	std::vector<springai::Weapon*> springai::StubUnit::GetWeapons() {
		return weapons;
	}

	springai::Weapon* springai::StubUnit::GetWeapon(WeaponMount* weaponMount) {
		return 0;
	}
