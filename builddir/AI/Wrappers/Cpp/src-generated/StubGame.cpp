...
#include "IncludesSources.h"
	...
	float springai::StubGame::GetRulesParamFloat(const char* gameRulesParamName, float defaultValue) {
		return 0;
	}

	const char* springai::StubGame::GetRulesParamString(const char* gameRulesParamName, const char* defaultValue) {
		return 0;
	}
