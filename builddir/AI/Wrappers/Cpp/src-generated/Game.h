...
public:
	 ...
	 */
public:
	virtual float GetRulesParamFloat(const char* gameRulesParamName, float defaultValue) = 0;

	/**
	 * @return string value of parameter if it's set, defaultValue otherwise.
	 */
public:
	virtual const char* GetRulesParamString(const char* gameRulesParamName, const char* defaultValue) = 0;
