...
#include "IncludesSources.h"
	...
	void springai::StubMap::SetAirLosMap(std::vector<int> airLosMap) {
		this->airLosMap = airLosMap;
	}
	std::vector<int> springai::StubMap::GetAirLosMap() {
		return airLosMap;
	}
	...
	void springai::StubMap::SetSonarMap(std::vector<int> sonarMap) {
		this->sonarMap = sonarMap;
	}
	std::vector<int> springai::StubMap::GetSonarMap() {
		return sonarMap;
	}

	void springai::StubMap::SetSeismicMap(std::vector<int> seismicMap) {
		this->seismicMap = seismicMap;
	}
	std::vector<int> springai::StubMap::GetSeismicMap() {
		return seismicMap;
	}
	...
	void springai::StubMap::SetSonarJammerMap(std::vector<int> sonarJammerMap) {
		this->sonarJammerMap = sonarJammerMap;
	}
	std::vector<int> springai::StubMap::GetSonarJammerMap() {
		return sonarJammerMap;
	}
	...
	void springai::StubMap::SetDeformable(bool isDeformable) {
		this->isDeformable = isDeformable;
	}
	bool springai::StubMap::IsDeformable() {
		return isDeformable;
	}

	void springai::StubMap::SetHardness(float hardness) {
		this->hardness = hardness;
	}
	float springai::StubMap::GetHardness() {
		return hardness;
	}

	void springai::StubMap::SetHardnessModMap(std::vector<float> hardnessModMap) {
		this->hardnessModMap = hardnessModMap;
	}
	std::vector<float> springai::StubMap::GetHardnessModMap() {
		return hardnessModMap;
	}

	std::vector<float> springai::StubMap::GetSpeedModMap(int speedModClass) {
